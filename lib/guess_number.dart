                      ...
                      child: ElevatedButton(
                        onPressed: () {
                          ...
                          if(guessResult > 0){
                            ...
                            setState(() {
                              _status = '$guess ทายถูกต้อง ( ทายไปทั้งหมด: ${widget._game.guessCount} )';
                            });
                          }
                        },
                        child: Text('GUESS'),
  ...
  Widget _buildButton(int? num) {
    return Padding(
      ...
      child: OutlinedButton(
        ...
        child: (num == -1) ? Icon(Icons.backspace,)  : (num == -2) ?
        Icon(Icons.close): Text('$num',style: TextStyle(
          fontSize: 25.0,
        ),),
      ),
    );
